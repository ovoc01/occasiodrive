...
--
-- Data for Name: announces_log; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.announces_log (date, id_announce, id_announces_log, id_person, status) FROM stdin;
\.


--
-- Data for Name: announces_picture; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.announces_picture (id_picture, id_announce, imagebyte) FROM stdin;
\.
...
COPY public.brand (id_brand, brand) FROM stdin;
1	Toyota
2	Mercedes
3	Mazda
4	Peugeot
...
--
-- Data for Name: favorite_announces; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.favorite_announces (id_announces, id_favorite, id_person) FROM stdin;
\.
...
COPY public.fuel_type (id_fuel_type, label) FROM stdin;
1	Essence
2	Diesel
3	Hydrogène
4	Electrique
...
--
-- Data for Name: model_category; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: model_category_motorisation; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: motorisation_fuel_type; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: motorisation_transmission; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
COPY public.person_user (id_person, id_person_user, role, email, password) FROM stdin;
1	1	0	admin@gmail.com	$2a$10$tjAKNe6D9SE1ZQQDj7nSJuum35KdXMzeTuRShfEXJGp5uQA/uw2Ee
2	2	0	123@gmail.com	$2a$10$POvsStevdKB0OrezN7GXe.HO7h.uyocnSvzg8ghuOT4Jlm0eldPWW
\.
