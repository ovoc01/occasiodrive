...
public class MessageController {
    ...
    public ResponseEntity<Object> getMessagesBySenderAndReceiver(@PathVariable Integer senderId, @PathVariable Integer receiverId) {
        try {
            List<Message> messages = messagerepository.findByIdSenderAndIdReceiver(senderId, receiverId);
            System.out.println(messages);
            HashMap<String, Object> map = new HashMap<>();
            map.put("message", "success");
            map.put("messages", messages);
